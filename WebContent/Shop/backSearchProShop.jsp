  ...
  <div class="row">
        <div class="col-xs-12 col-sm-3">
          <div class="picture thumbnail">
                    <a href="<%=request.getContextPath()%>/shop.do?action=checkone&ITEMNO=${shopVO.ITEMNO}&PRO=1"><img class="img-responsive" img src="<%=request.getContextPath()%>/DBPicReader?ITEMNO=${shopVO.ITEMNO}" style=" height: 188px; width: 188px;" title="##"></a>
                  </div>
        </div>
              ...
              <div class="product-item">
                <div class="white-box">
                  ...
                  <div class="middle-content">
                    <h2 class="product-title"><a href="<%=request.getContextPath()%>/shop.do?action=checkone&ITEMNO=${shopVO.ITEMNO}&PRO=1">${shopVO.SHOPNAME}</a></h2>
