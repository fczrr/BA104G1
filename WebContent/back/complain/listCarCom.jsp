			...
			<div class="col-md-12">
				<div id="mytitle"
					...
					<a class="btn btn-block btn-lg btn-primary" data-toggle="modal"
						data-target="#mymodal">
						<h1>
							<i class="fa fa-car" aria-hidden="true"></i> 派車申訴&nbsp;<b>管理頁面</b>
						</h1>
					...
					<div class="x_panel">
						...
						<div class="x_title">
							<ul class="nav navbar-right panel_toolbox">
								<div class="btn-group">
									<a
										href="<%=request.getContextPath()%>/back/complain/listCarCom.jsp"
										class="btn btn-info" role="button">全部申訴</a> 
										<a href="<%=request.getContextPath()%>/carcomplain/carcomplain.do?action=Off_Status"
										class="btn btn-danger" role="button">未處理</a>
										 <a href="<%=request.getContextPath()%>/carcomplain/carcomplain.do?action=On_Status"
							...
							<div class="row">
								...
								<div class="panel-body">
									<table id="mytable"
										...
										<c:forEach var="carComplainVO" items="${list}"
											begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
											<!--將修改的那一筆加入對比色而已-->
											<tbody id="mytablebody"
												${(carComplainVO.complainNo == param.complainNo) ? 'text-primary':''}
												valign='middle'>
												...
												<td class="hidden-xs" data-toggle="modal"
													...
													class="btn btn-info actionReply"> <input type="hidden"
														...
														disabled="disabled" value="${carComplainVO.complainNo}">
														<input type="hidden" name="emp_no" class="emp_no"
														disabled="disabled" value="${employeeVO.empNo}"> <input
														type="hidden" name="action" value="getOne_For_Updat_car">
												...
												<td class="col-text" data-toggle="modal"
													...
													class="btn btn-default clickDetail"> <i
														...
														value="${carComplainVO.complainNo}"> <input
														...
														<form>
															...
															<div class="form-group">
																...
																<p id="complainIn" class="repComTime">
																	<%-- ${sdf.format(carComplainVO.detailDate)} --%>
																</p>
															</div>
															<div class="form-group">
														...
														<div class="btn-group btn-group-justified" role="group"
															...
															<div class="btn-group" role="group">
																...
																<input type="hidden" name="complainNo" class="replyNoDe"
																	value="${carComplainVO.complainNo}">
															</div>
														</div>
													</div>
												</div>
                ...
                <p id="complainIn" class="empIdM">${employeeVO.EmpNo}</p>
															...
															<div class="form-group">
																...
																<p id="complainIn" class="reptime">
																	<%-- ${sdf.format(carComplainVO.replyDate)} --%>
																</p>
															</div>
														</form>
...
// 查詢詳細資料 AJAX方法
	...
	/carcomplain/carcomplain.do?action=getOne_For_Display&complainNo="
																+ seach.val(), //請求目標的url，可在url內加上GET參數，如 www.xxxx.com?xx=yy&xxx=yyy
														//	    		 data:text,  //要傳給目標的data
														dataType : "json",
