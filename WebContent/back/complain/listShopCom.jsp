		...
		<div class="col-md-8">
			<div class="tab-content ">
				...
				<ul class="nav nav-tabs custom-tab">
					...
					<li class="tapone active"><a href="<%=request.getContextPath()%>/back/complain/listShopCom.jsp"><i class="fa fa-shopping-bag" aria-hidden="true"></i>&nbsp商城申訴</a></li>
				</ul>
			</div>
		</div>
	<div class="row">
...
<%@ include file="page1.file" %>  
  			<c:forEach var="shopComplainVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
   					<!--將修改的那一筆加入對比色而已-->
                        <tbody id="mytablebody" ${(shopComplainVO.complainNo == param.complainNo) ? 'text-primary':''} valign='middle'>
 						...
 						<c:choose>
                            ...
                            <td class="hidden-xs" data-toggle="modal"  data-target="#ansower">
                                ...
                                <input type="hidden" name="complainNo" class="complainNoDetail serchNo" disabled="disabled" value="${shopComplainVO.complainNo}">
                            ...
                            <td class="col-text" data-toggle="modal"  data-target="#moreDetail">
                                ...
                                <i class="fa fa-chevron-down"></i>
                                 <input type="hidden" name="complainNo" class="complainNoDetail" value="${shopComplainVO.complainNo}">
        ...
        <div class="modal-body">
            ...
            <form>
              <div class="form-group">
                ...
                <p id="complainIn" class="repComNo"><%-- ${shopComplainVO.complainNo} --%></p>
              </div>
             <div class="form-group">
                <label for="complainNo" id="complainTi"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> 申訴時間 : </label>
                <p id="complainIn" class="repComTime"><%-- ${sdf.format(shopComplainVO.detailDate)} --%></p>
              </div>
              <div class="form-group">
                <label for="complainIntro" id="complainTi"><i class="fa fa-envelope fo-1x" aria-hidden="true"></i> 申訴內容 : </label>
                <p id="complainIn" class="repComDetail"><%-- ${shopComplainVO.complainDetail} --%></p>
              </div>
        ...
        <div class="modal-footer">
            <div class="btn-group btn-group-justified" role="group" aria-label="group button">
				...
				<div class="btn-group" role="group">
                    ...
                    <input type="hidden" name="complainNo" class="replyNoDe" value="${shopComplainVO.complainNo}">
                    <input type="hidden" name="whichPage"	value="<%=whichPage%>">               <!--送出當前是第幾頁給Controller-->	    
                </div>
            </div>
        </div>
...
<div class="modal fade" id="moreDetail" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
            <h3 class="modal-title detailBack" id="lineModalLabelDe"><%-- ${shopComplainVO.complainNo} --%>：<%-- ${shopComplainVO.complainStatus} --%></h3>
        </div>
        <div class="modal-body">
            ...
            <form>
              <div class="form-group">
                ...
                <p id="complainIn" class="orderNoDe"><%-- ${shopComplainVO.mo_no} --%></p>
              </div>
              <div class="form-group">
                <label for="complainIntro" id="complainTi"><i class="fa fa-envelope fo-1x" aria-hidden="true"></i> 申訴內容 : </label>
                <p id="complainIn" class="compDe"><%-- ${shopComplainVO.complainDetail} --%></p>
              </div>
                <div class="form-group">
                <label for="complainIntro" id="complainTi"><i class="fa fa-clock-o" aria-hidden="true"></i> 申訴時間 : </label>
                <p id="complainIn" class="comptime"><%-- ${sdf.format(shopComplainVO.detailDate)} --%></p>
              </div>
              <hr>
              <div class="form-group">
                <label for="complainIntro" id="complainTi"><i class="fa fa-envelope fo-1x" aria-hidden="true"></i> 回覆申訴 : </label>
                <p id="complainIn" class="compRep"><%-- ${shopComplainVO.complainReply} --%></p>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <p id="complainIn" class="reptime"><%-- ${sdf.format(shopComplainVO.replyDate)} --%></p>
              </div>
            </form>
