                ...
                <div class="panel-body">
                    <table id="mytable" class="table table-striped table-bordered table-list results">
                        ...
                        <div class="form-group newform formtopp">
                            ...
                            <div class="col-md-12">
                                <p id="newsno" name="newsno" type="text" placeholder="消息編號" class="form-control">${newsdetailVO.newsno}<p>
                            </div>
                        </div>
                        <!-- Email input-->
                        <div class="form-group newform">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control" id="newstitle" name="newstitle" placeholder="請輸入文章標題" rows="2">${newsdetailVO.newstitle}</textarea>
                            </div>
                        </div>
                        <!-- Message body -->
                        <div class="form-group newform">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control" id="newsintro" name="newsintro" placeholder="請輸入文章內容" rows="7">${newsdetailVO.newsintro}</textarea>
                            </div>
                        </div>
                        <div class="form-group newform" id="forstat">
                            ...
                            <div class="col-md-10 checkin">
                                <input type="radio" id="onstat" class="onStat" name="status" value="上架" ${(newsdetailVO.status == '上架')?'checked':'' } /> 上架&nbsp&nbsp
                                <input type="radio" id="offStat" class="offStat" name="status" value="下架" ${(newsdetailVO.status == '下架')?'checked':'' } /> 下架
                            </div>
                        </div>
                        <div class="form-group newform">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <p><img id="img" class="forUpnewsPiccc" src="<%=request.getContextPath()%>/newsdetail/newsimgread.do?newsno=${newsdetailVO.newsno}" style=width:30%;></p>
                                </div>
                            </div>
                        </div>
                        <!-- Form actions -->
