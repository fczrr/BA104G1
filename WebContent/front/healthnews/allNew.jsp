...
<c:forEach var="healthNewsDetailVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">    
        ...
        <div class="col-xs-10 col-sm-12" style="border: 1px solid #aaa; margin-top: 10px; margin-left:10px; margin-bottom: 20px;    width: -webkit-fill-available">
            <div class="col-xs-10 col-sm-4" style="margin-left: 0px; padding-left: 0px">
                <a><img class="" src="<%=request.getContextPath()%>/healthnewsdetail/healthimgread.do?healthNo=${healthNewsDetailVO.healthNo}" style="max-width:260px; max-height:170px; vertical-align:center" /></a>
            </div>
