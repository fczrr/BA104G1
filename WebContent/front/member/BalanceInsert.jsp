	...
	<div class="container">
		...
		<div class="col-xs-12 col-sm-6 col-sm-offset-3">
			...
			<form method="post"
				...
				<table>
					<tr>
						<td colspan="2"><h1 class="text-center">信用卡加值</h1></td>
					</tr>
					<tr>
						<td>會員編號:</td>
						<td>${memberVO.memNo}</td>
						<td><input type="hidden" class="form-control" id="memNo"
							name="memNo" value="${memberVO.memNo}"> <input
							type="hidden" class="form-control" id="topupWay" name="topupWay"
							value="CREDIT"></td>
					</tr>
					<tr>
						<td>儲值金額</td>
						<td><input type="text" class="form-control crd"
							id="topupValue" name="topupValue" value="" style="width: 100px;">
						</td>
					</tr>
					<tr>
						<td>信用卡卡號</td>
						<td>
							...
							<div class="crd">
								<input type="password" class="form-control" id="creditCard1"
									style="width: 70px" />
							</div>

							<div class="crd" style="width: 20px; text-align: center;">
								-</div>
							<div class="crd">
								<input type="password" class="form-control" id="creditCard2"
									style="width: 70px" />
							</div>
							...
							<div class="crd" style="width: 20px; text-align: center;">
								-</div>
							<div class="crd">
								<input type="password" class="form-control" id="creditCard3"
									style="width: 70px" />
							</div>
							...
							<div class="crd" style="width: 20px; text-align: center;">
								-</div>
							<div class="crd">
								<input type="text" class="form-control" id="creditCard4"
									style="width: 70px" />
							</div>
						</td>
					</tr>
					<tr>
						<td>信用卡有效期限</td>
						<td><input type="text" class="form-control" id="yymm"
							placeholder="如：2212" style="width: 100px;"></td>
					</tr>
					<tr>
						<td>背面檢查碼</td>
						<td>
							<div class="crd" style="width: 100px; text-align: center;">
								<input type="text" class="form-control" id="code"
									placeholder="如：123" style="width: 100px;">
							</div>

							<div class="crd">
								<img alt=""
									src="<%=request.getContextPath()%>/img/balance/end3.png"
									height="35px">
							</div>
						</td>
					</tr>
					...
					<tr>
						<td>
							<p>
								...
								<input type="hidden" name="myurl" value="${myurl}"> <input
									type="hidden" name="memNo" value="${memberVO.memNo}"> <input
									type="submit" class="btn-danger" value="確定送出">
							</p>
						</td>
					</tr>
					<tr>
