...
<body>
	<div class="container">
		<div class="row">
			...
			<hr>
			<img alt=""
				src="<%=request.getContextPath()%>/img/member/longterm5.jpg">
				...
				<div class="row">
					<table class="table table-hover">
						...
						<tr>
							<td>
								<FORM METHOD="post"
									ACTION="<%=request.getContextPath()%>/front/member/BalanceInsert.jsp">
									<input type="submit" value="加值" class=" btn-success"> <input
