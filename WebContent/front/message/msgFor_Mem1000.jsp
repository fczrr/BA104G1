   ...
   var MyPoint = "/MessageServlet/EMP00002";
	...
	function connect() {
		...
		webSocket.onmessage = function(event) {
			...
			var receiver = $("#receiver").val(jsonObj.sender);
			
console.log('userName:'+self);
		...
		if(self == jsonObj.sender){
			...
			if(src =='null'){
				msg=
					...
					'<img src="<%=request.getContextPath() %>/front/img/index/share/09.jpg" class="img-circle img-sm img-right">'+
					'<p class="nametext-right">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</p>'+
					'<p class="speeh-text-right msgaaaa">'+jsonObj.message+'</p>'+
					'</div>'+
