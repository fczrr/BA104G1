...
public class GenerateToken {
   ...
   public static String getToken(String userName1){
	   
	   String token = null;
       String key = "9e2f8944e8d04606be853131f80fe599";
       String appID = "9915b8.vidyo.io";
       ...
       try {
           ...
           token  = generateProvisionToken(key, userName + "@" + appID, expiresInSeconds, vCard);
