...
class MemChatRoom{
	...
	public static Map<String , SchedulEchoServer>emp_session = Collections.synchronizedMap(new HashMap<>());
	
}

@ServerEndpoint("/SchedulEchoServer/{myName}/{myRoom}")
public class SchedulEchoServer {
