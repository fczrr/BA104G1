...
System.out.println("進入cartservlet");
		...
		System.out.println("req.getParameter(\"STOCK\")"+req.getParameter("STOCK"));
		System.out.println("req.getParameter(\"action\")"+req.getParameter("action"));
		System.out.println("req.getParameter(\"ITEMNO\")"+req.getParameter("ITEMNO"));
