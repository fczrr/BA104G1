package com.employee_photo.controller;
...
public class EmployeePhotoServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("getAllByDateTime".equals(action)) { // 來自select_page.jsp的請求
			...
			try {
				...
				if (!errorMsgs.isEmpty()) {
					RequestDispatcher failureView = req
							.getRequestDispatcher("/front/Hc_order.jsp");
				...
				req.setAttribute("hcWorkShiftsVOList", hcWorkShiftsVOList); // 資料庫取出的empVO物件,存入req
				String url = "/front/Hc_order.jsp";
